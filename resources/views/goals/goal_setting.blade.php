				...
				<div class="card  card-absolute">				
					...
					<div class="card-body">
						<div class="table-responsive">
							...
							<button type="submit" id="Excel_generation_id" class="btn btn-secondary" style="margin-bottom: 14px;"><i class="ti-save"></i>Export Excel</button>
...
@section('script')
	...
	<script>
		...
		$(()=>{
                $("#Excel_generation_id").on('click',(e)=>{
                    e.preventDefault();
                    var params = new window.URLSearchParams(window.location.search);
                    // var id=params.get('id')
					var id=@json($sheet_code);
