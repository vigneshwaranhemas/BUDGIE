                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="row">
                                <div class="col-md-7">
                                    <p class="mb-0 f-w-600" style="font-size: 16px;"><i class="icofont icofont-building"> </i> Apprentice Dept:</p>
                                </div>
                                <div class="col-md-5">
...
<script>
    ...
    function additionalKRA(x,cur_rowCount) {
        ...
        html11 +='<div class="dropup m-t-35">';
            ...
            // html7 +='<button type="button" class="btn btn-xs btn-danger sub_row_'+cur_rowCount+'" onclick="removeRow(this,'+class_sub+');" style="padding:0.37rem 0.8rem !important;" data-original-title="Edit KOA" title="Edit KOA"><i class="fa fa-close"></i></button>';
        html11 +='</div>';
                ...
                html +='<td>';
                    html +='<div class="dropup">';
                        ...
                        html +='<div class="dropdown-menu" style="transform: translate3d(-17px, 21px, 0px) !important; min-width: unset;" aria-labelledby="dropdownMenuButton">';
                                    ...
                                    // html +='<a class="dropdown-item ditem-gs"><button class="btn btn-info btn-xs" type="button" data-original-title="Edit KOA" title="Edit KOA"><i class="fa fa-pencil"></i></button></a>';
